      ...
      <div className="p-4">
        ...
        <div className="bg-unionbank-orange rounded-xl p-4 text-white mb-4 relative">
          <div className="flex justify-between items-center mb-1">
            <h3 className={`${isMobile ? 'text-base' : 'text-lg'} font-bold uppercase text-white/90`}>PRINCE IVANN BODO COMISO</h3>
        ...
        <Card className="p-6 shadow-sm mb-16 rounded-xl">
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 mb-1 flex items-center justify-center">
                <img src="/lovable-uploads/046025eb-c8f8-4a33-9bb1-0b655f1d2e19.png" alt="Send Money" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 mb-1 flex items-center justify-center">
                <img src="/lovable-uploads/09912f0f-39b3-4704-9285-257b332724f5.png" alt="Receive Money" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 mb-1 flex items-center justify-center">
                <img src="/lovable-uploads/3a9c61a0-d575-47f7-b413-c964b4a6e931.png" alt="Pay Bills" className="w-full h-full object-contain" />
              </div>
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 mb-1 flex items-center justify-center">
                <img src="/lovable-uploads/9c04d07b-cc81-4eb3-bdb0-7dfc68f894ed.png" alt="Promos" className="w-full h-full object-contain" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 mb-1 flex items-center justify-center">
                <FileCheck size={24} className="text-unionbank-orange" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 mb-1 flex items-center justify-center">
                <CircleDollarSign size={24} className="text-unionbank-orange" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 mb-1 flex items-center justify-center">
                <CreditCard size={24} className="text-unionbank-orange" />
              </div>
